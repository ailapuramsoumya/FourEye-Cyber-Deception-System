...
--
-- Host: localhost
-- Generation Time: Sep 22, 2022 at 01:05 PM
...
-- Database: `foureye`
--
CREATE DATABASE IF NOT EXISTS `foureye` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `foureye`;
...
('5cjaob90omnc89htntc49m6ag15ieyez', 'eyJ1c2VyaWQiOjJ9:1obLnx:et_XZZlL0l24SzTR6mHXQ-zOMkHtLtMbPFBYnV0y1L8', '2022-10-06 12:59:49.944179'),
...
('g7jrqi1vaskys8oz9njjpjexluikybph', 'eyJ1c2VyaWQiOjF9:1oU1RW:2nSIt0SUSSmKqtG5_NVXw_KTgibZSBZJORBo1ssPaIc', '2022-09-16 07:50:22.680355'),
('hbh8yj75dejr4cbnf8mnav4b6kctj25e', 'eyJ1c2VyaWQiOjR9:1oU3eZ:4PHwxUqdUcd43ZgdXOlf29b6yDBDGeJ9YkY97-lZWa4', '2022-09-16 10:11:59.973150'),
...
('qm927hwt7f33ju86sa82ssx6io8ch8oh', 'eyJ1c2VyaWQiOjF9:1obJZo:YUn17wHxzksDI8jtyPmUmzPk42MP3O5hOTX5yCkbyCI', '2022-10-06 10:37:04.584040'),
...
(35, 'Naive Bayes', '50.41682455475559'),
(36, 'SVM', '51.43993937097385'),
(37, 'Logistic Regression', '51.26942023493748'),
(38, 'Decision Tree Classifier', '51.42099280030315'),
(39, 'SGD Classifier', '49.52633573323229');
...
--
-- Table structure for table `remote_user_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Flow_ID` varchar(3000) NOT NULL,
  `Source_IP` varchar(3000) NOT NULL,
  `Source_Port` varchar(3000) NOT NULL,
  `Destination_IP` varchar(3000) NOT NULL,
  `Destination_Port` varchar(3000) NOT NULL,
  `Timestamp` varchar(3000) NOT NULL,
  `Flow_Duration` varchar(3000) NOT NULL,
  `Total_Fwd_Packets` varchar(3000) NOT NULL,
  `Total_Backward_Packets` varchar(3000) NOT NULL,
  `Total_Length_of_Fwd_Packets` varchar(3000) NOT NULL,
  `Total_Length_of_Bwd_Packets` varchar(3000) NOT NULL,
  `Fwd_Packet_Length_Max` varchar(3000) NOT NULL,
  `Fwd_Packet_Length_Min` varchar(3000) NOT NULL,
  `Bwd_Packet_Length_Max` varchar(3000) NOT NULL,
  `Flow_Bytes` varchar(3000) NOT NULL,
  `Flow_Packets` varchar(3000) NOT NULL,
  `Fwd_Packets` varchar(3000) NOT NULL,
  `Bwd_Packets` varchar(3000) NOT NULL,
  `Max_Packet_Length` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_detection_type`
--

INSERT INTO `remote_user_detection_type` (`id`, `Flow_ID`, `Source_IP`, `Source_Port`, `Destination_IP`, `Destination_Port`, `Timestamp`, `Flow_Duration`, `Total_Fwd_Packets`, `Total_Backward_Packets`, `Total_Length_of_Fwd_Packets`, `Total_Length_of_Bwd_Packets`, `Fwd_Packet_Length_Max`, `Fwd_Packet_Length_Min`, `Bwd_Packet_Length_Max`, `Flow_Bytes`, `Flow_Packets`, `Fwd_Packets`, `Bwd_Packets`, `Max_Packet_Length`, `Prediction`) VALUES
(1, '10.42.0.42-52.179.189.71-54061-443-6', '10.42.0.42', '54061', '52.179.189.71', '443', '04-08-17 8:15', '49629', '1', '1', '0', '0', '0', '0', '0', '0', '40.29901872', '20.14950936', '20.14950936', '0', 'Threat'),
(2, '172.217.12.162-10.42.0.151-443-41454-6', '172.217.12.162', '443', '10.42.0.151', '41454', '05-08-17 6:28', '2080', '2', '1', '0', '0', '0', '0', '0', '0', '1442.307692', '961.5384615', '480.7692308', '0', 'Benign'),
(3, '172.217.3.106-10.42.0.211-443-41106-6', '10.42.0.211', '41106', '172.217.3.106', '443', '11-07-17 10:57', '51597803', '6', '6', '1496', '1178', '748', '0', '515', '51.82391196', '0.232568042', '0.116284021', '0.116284021', '748', 'Threat'),
(4, '173.194.175.188-10.42.0.151-5228-34789-6', '10.42.0.151', '34789', '173.194.175.188', '5228', '04-08-17 10:44', '128500', '2', '0', '0', '0', '0', '0', '0', '0', '15.56420233', '15.56420233', '0', '0', 'Threat'),
(5, '172.217.12.161-10.42.0.151-443-54018-6', '172.217.12.161', '443', '10.42.0.151', '54018', '04-08-17 10:43', '36', '2', '0', '55', '0', '55', '0', '0', '1527777.778', '55555.55556', '55555.55556', '0', '55', 'Threat');
